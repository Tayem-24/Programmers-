...
def life1():
    ...
    #==========lable============
    l4=Label(app3,text='life coaches',fg='red',bg='black',font=('times for romans', 20, 'bold'))
    l4.place(x=110,y=10)
    l5=Label(app3,text='take to the coach (mr......)',fg='red',bg='white',font=('times for romans', 10, 'bold'))
